...
use Arsenyk\Component\Model\TestModel as Model;
use Arsenyk\Component\Model\TestModelLocalized as ModelLocalized;
use Arsenyk\Component\Model\TestModelLocale as ModelLocale;
use Arsenyk\Component\Model\Statusable\StatusableTrait;
use Arsenyk\Component\Model\Nameable\NameableTrait;
...
class AllTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $online = StatusableTrait::getAvailableStatus()['STATUS_ONLINE'];
        $model = new Model();
    ...
    public function testStatusableTraitException()
    {
        $online = 100;
        $model = new Model();
